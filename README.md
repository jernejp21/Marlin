...
This FW is compiled for use with [Katapult](https://github.com/Arksine/katapult) bootloader wiht 4 kiB offset. It means, that the code starts on address 0x0800_1000 of STM32F103 MCU.
To change address offset go to script `ini/stm32f1.ini`. And change lines 63 and 64.
