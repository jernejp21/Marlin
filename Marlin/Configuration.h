...
#define STRING_CONFIG_H_AUTHOR "Jernej Pangerc" // Who made the changes.
...
//#define BAUDRATE_2 112500   // Enable to override BAUDRATE
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -2.95 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS / 2), (Y_MAX_POS - 10), 40 }
